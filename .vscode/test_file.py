...
# with open(r'C:\Users\home\Desktop\OOP2\2.txt') as file:
#     res = file.read()
#     print(res)

# f = open('3.txt', 'w')
# f.write('Hello world\n')
# f.write('Spartak is a champion of the world\n')
# f.close()

# f = open('3.txt', 'w')
# f.writelines(['Hello world\n', 'Spartak is a champion of the world\n'])
# f.close()
